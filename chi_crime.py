...
class GraphAttentionLayer(nn.Module):
    ...
    def forward(self,  h: torch.Tensor, adj_mat: torch.Tensor):
        ...
        e = self.leakyrelu(self.interaction_matrix)
...
def train(rank, world_size, model, hyperparameters, accumulation_steps, data_scaler, val_loader):
    ...
    for epoch in range(hyperparameters.epochs):
        ...
        if is_main():
            ...
            print(f"LR after scheduler.step: {cur_lr:.6g}")
...
def load_data(batch_size, accumulation_steps):
    ...
    data_path = os.path.join('chi_crime_42x35x7670x4.npz')
    ...
    adj_weight = build_grid_adj_weight(start_pos = (41.644585429, -87.939732936), end_pos = (42.022910333, -87.524529378), row = 42, col = 35)
